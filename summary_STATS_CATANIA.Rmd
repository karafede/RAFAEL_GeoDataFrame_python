...
data_GG <- read_csv("route_CATANIA_GG.csv")[-1]
...
### auto ###
BBB <- NULL
bin_trip = seq(from = 0, to = 80, by = 5)   ## max 2 ore trip = 120 minutes (2 hour trip)
...
### auto ###
BBB <- NULL
bin_stop = seq(from = 0, to = 120, by = 10)   
...
### veicoli commerciali ###
BBB <- NULL
bin_stop = seq(from = 0, to = 120, by = 10)   ## max 2 ore trip = 120 minutes (2 hour trip)

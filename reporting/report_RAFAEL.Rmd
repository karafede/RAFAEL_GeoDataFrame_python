...
7) Stima della **"transition probability"** intesa come la probabilita' che la distanza (sul grafo) tra due nodi consecutivi (u-->v ed adiacenti a due traccie GPS)  sia vicina alla distanza euclidea tra i due nodi stessi.

...
accuracy_2019_90_100 <- rbind(accuracy_2019_90_100, accuracy_2019_100_105, accuracy_2019_105_110)
...
p <- ggplot(accuracy_2019, aes(x = matched_distance)) +
  ...
  # geom_vline(xintercept = 800, col="blue", lty=2, size=1) +
  geom_vline(xintercept = 1600, col="blue", lty=2, size=1) +
  geom_vline(xintercept = 2700, col="blue", lty=2, size=1) +
  geom_text(aes(x = 4000 , y = 0.15 , label = "2.8 km"), size = 4) +
  geom_text(aes(x = 6300 , y = 0.15 , label = "5 km"), size = 4) +
